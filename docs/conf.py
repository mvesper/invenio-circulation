...
html_theme_options = {
    'description': 'Circulation Module',
    ...
    'extra_nav_links': {
        'invenio-circulation@GitHub': 'http://github.com/https://github.com/mvesper/invenio-circulation',
...
texinfo_documents = [
  (master_doc, 'invenio-circulation', u'invenio-circulation Documentation',
   author, 'invenio-circulation', 'Circulation Module',
   'Miscellaneous'),
]
