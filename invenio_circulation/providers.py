...
class CirculationLoanCycleProvider(BaseProvider):
    """Circulation identifier provider."""
    ...
    def create(cls, object_type=None, object_uuid=None, **kwargs):
        ...
        assert 'pid_value' in kwargs
        kwargs.setdefault('status', cls.default_status)
        return super(CirculationLoanCycleProvider, cls).create(
            object_type=object_type, object_uuid=object_uuid, **kwargs)
...
class CirculationItemProvider(BaseProvider):
    ...
    def create(cls, object_type=None, object_uuid=None, **kwargs):
        ...
        cn = kwargs.pop('recid')
        pid_value = '{0}-{1}'.format(cn,
                                     models.CirculationItemIdentifier.next(cn))
