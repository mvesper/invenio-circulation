...
(function (angular) {
  ...
  function CirculationController($scope, ItemStore, UserStore, SettingsStore) {
    var vm = this;
    var relevantActions = [
      ['loan', 'loan'],
      ['request', 'request'],
    ...
    $scope.$watch(function() {
      ...
      ItemStore.validateItems(relevantActions);
    }, true);
    ...
    function loanItems() {
      performActionOnItems('loan')
    }
    
    function requestItems() {
      performActionOnItems('request')
    }

    function returnItems() {
      performActionOnItems('return')
    }
